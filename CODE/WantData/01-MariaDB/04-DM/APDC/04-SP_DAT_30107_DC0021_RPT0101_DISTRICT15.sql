DROP PROCEDURE IF EXISTS APDC.SP_DAT_30107_DC0021_RPT0101_DISTRICT15;

CREATE PROCEDURE APDC.SP_DAT_30107_DC0021_RPT0101_DISTRICT15 (
...
BEGIN
    ...
    INSERT INTO APDC.DC0021_RPT0101_DISTRICT15
    ...
    --UPDATE2
    --從直式取MAX
    UPDATE APDC.DC0021_RPT0101_DISTRICT15 A 
    ...
    JOIN(SELECT DIVISION_ID
              , DIVISIOND_ID
              , DISTRICT15_ID
              , (CASE WHEN RPT_YMD=VAR_DATA_DATE THEN SUM(BILLING_D3) ELSE 0 END) AS BILLING_D3
         ...
         GROUP BY DIVISION_ID
                , DIVISIOND_ID
                , DISTRICT15_ID) B
    ON A.DATA_DATE=B.DATA_DATE AND A.RPT_YMD=B.RPT_YMD AND A.DIVISION_ID=B.DIVISION_ID AND A.DIVISIOND_ID=B.DIVISIOND_ID AND A.DISTRICT15_ID=B.DISTRICT15_ID
    ...
    JOIN(SELECT M.DIVISION_ID
              ...
              , (CASE WHEN M.RPT_YMD=@RPT_YMD_END THEN 'Z'
                      WHEN M.SALES_AMT_PAST_MONTH THEN 'A' ELSE NULL END) AS PAST_PROG_REACH_RATE_BILLING_F
              ...
              , (CASE WHEN M.RPT_YMD<>@RPT_YMD_END THEN 'Z'
                      WHEN M.SALES_AMT_PAST_MONTH THEN 'A' ELSE NULL END) AS PAST_PROG_REACH_RATE_POST_F
              , N.PAST_PROG_GROWTH_RATE_BILLING AS PAST_PROG_GROWTH_RATE_BILLING
              , (CASE WHEN M.RPT_YMD=@RPT_YMD_END THEN 'Z'
                      WHEN N.PAST_PROG_GROWTH_RATE_BILLING<0 THEN 'A'
                      WHEN M.SALES_AMT_PAST_PROG THEN 'B' ELSE NULL END) AS PAST_PROG_GROWTH_RATE_BILLING_F
              , N.PAST_PROG_GROWTH_RATE_POST AS PAST_PROG_GROWTH_RATE_POST
              , (CASE WHEN M.RPT_YMD<>@RPT_YMD_END THEN 'Z'
                      WHEN N.PAST_PROG_GROWTH_RATE_POST<0 THEN 'A'
                      WHEN M.SALES_AMT_PAST_PROG THEN 'B' ELSE NULL END) AS PAST_PROG_GROWTH_RATE_POST_F
    ...
    JOIN(SELECT DIVISION_ID
         ...
         FROM APDC.DC0021_RPT0101_DISTRICT15
         WHERE DATA_DATE=VAR_DATA_DATE
         GROUP BY DIVISION_ID
                , DIVISIOND_ID
                , DISTRICT15_ID) B
    ON A.DATA_DATE=B.DATA_DATE AND A.RPT_YMD=B.RPT_YMD AND 
       A.DIVISIONC_ID=B.DIVISIONC_ID AND A.DIVISION_ID=B.DIVISION_ID AND A.DIVISIOND_ID=B.DIVISIOND_ID AND A.DISTRICT15_ID=B.DISTRICT15_ID
