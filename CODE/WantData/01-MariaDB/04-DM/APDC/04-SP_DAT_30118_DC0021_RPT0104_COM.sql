DROP PROCEDURE IF EXISTS APDC.SP_DAT_30118_DC0021_RPT0104_COM;

CREATE PROCEDURE APDC.SP_DAT_30118_DC0021_RPT0104_COM (
...
BEGIN
    ...
    --INSERT1
    INSERT INTO APDC.DC0021_RPT0104_COM
    SELECT VAR_DATA_DATE AS DATA_DATE
         , VAR_DATA_DATE AS RPT_YMD
         , DIVISION_ID
         , NULL AS DIVISION_NM
         , DISTRICT8_ID
         , NULL AS DISTRICT8_NM
         , 'DIST8_SUPV_ID' AS DIST8_SUPV_ID
         , COM_ID
         , NULL AS COM_NM
         ...
         , 0 AS SALES_PAST_REACH_RATE_RSSBT450_BEV1SN
         ...
         , 0 AS SALES_PAST_REACH_RATE_OLD_PROD_BEV1SN
    ...
    --UPDATE2
    --新品帳餘
    UPDATE APDC.DC0021_RPT0104_COM A
    ...
    ON A.DATA_DATE=B.DATA_DATE AND A.RPT_YMD=B.RPT_YMD AND A.DIVISION_ID=B.DIVISION_ID AND A.DISTRICT8_ID=B.DISTRICT8_ID AND A.COM_ID=B.COM_ID
    ...
    --UPDATE3
    --UPDATE兩次SALES_PAST_REACH_RATE_RSSBT450_V 乳酸水瓶裝450ml同期達成率(畫面數值)
    UPDATE APDC.DC0021_RPT0104_COM A
    JOIN(SELECT DIVISION_ID
              , SALES_PAST_REACH_RATE_RSSBT450_V AS SALES_PAST_REACH_RATE_RSSBT450_BEV1SN
              , SALES_PAST_REACH_RATE_OLD_PROD_V AS SALES_PAST_REACH_RATE_OLD_PROD_BEV1SN
         FROM APDC.DC0021_RPT0104_DIVISION
         WHERE DATA_DATE=VAR_DATA_DATE AND RPT_YMD=VAR_DATA_DATE AND DIVISION_ID=@DIVISION_ID_BEV1S
         GROUP BY DIVISION_ID) B
    ON A.DATA_DATE=B.DATA_DATE AND A.RPT_YMD=B.RPT_YMD AND A.DIVISION_ID=B.DIVISION_ID
    SET A.SALES_PAST_REACH_RATE_RSSBT450_BEV1SN=B.SALES_PAST_REACH_RATE_RSSBT450_BEV1SN
      , A.SALES_PAST_REACH_RATE_OLD_PROD_BEV1SN=B.SALES_PAST_REACH_RATE_OLD_PROD_BEV1SN
    WHERE A.DATA_DATE=VAR_DATA_DATE AND A.RPT_YMD=VAR_DATA_DATE
    ;
    ...
    JOIN(SELECT DIVISION_ID
              ...
              , SALES_PAST_REACH_RATE_OLD_PROD_V AS SALES_PAST_REACH_RATE_OLD_PROD_BEV1SN
         FROM APDC.DC0021_RPT0104_DIVISION
         WHERE DATA_DATE=VAR_DATA_DATE AND RPT_YMD=VAR_DATA_DATE AND DIVISION_ID=@DIVISION_ID_BEV1N
         GROUP BY DIVISION_ID) B
    ON A.DATA_DATE=B.DATA_DATE AND A.RPT_YMD=B.RPT_YMD AND A.DIVISION_ID=B.DIVISION_ID
    SET A.SALES_PAST_REACH_RATE_RSSBT450_BEV1SN=B.SALES_PAST_REACH_RATE_RSSBT450_BEV1SN
      , A.SALES_PAST_REACH_RATE_OLD_PROD_BEV1SN=B.SALES_PAST_REACH_RATE_OLD_PROD_BEV1SN
    ...
    JOIN(SELECT DIVISION_ID
              ...
              , (CASE WHEN ROUND(SALES_AMT_REACH_RSSBT450/SALES_AMT_PAST_MONTH_RSSBT450,3)<0 THEN 0.00 ELSE NULL END) AS SALES_PAST_REACH_RATE_RSSBT450_V
              , (CASE WHEN ROUND(SALES_AMT_REACH_RSSBT450/SALES_AMT_PAST_MONTH_RSSBT450,3)<SALES_PAST_REACH_RATE_RSSBT450_BEV1SN THEN 'A'
                      WHEN SALES_AMT_PAST_MONTH_RSSBT450<=0 THEN 'B' ELSE NULL END) AS SALES_PAST_REACH_RATE_RSSBT450_F
              , ROUND(TOTAL_SALES_AMT_OLD_PROD/SALES_AMT_PAST_MONTH_OLD_PROD,3) AS SALES_PAST_REACH_RATE_OLD_PROD
              , (CASE WHEN ROUND(TOTAL_SALES_AMT_OLD_PROD/SALES_AMT_PAST_MONTH_OLD_PROD,3)<0 THEN 0.00 ELSE NULL END) AS SALES_PAST_REACH_RATE_OLD_PROD_V
              , (CASE WHEN ROUND(TOTAL_SALES_AMT_OLD_PROD/SALES_AMT_PAST_MONTH_OLD_PROD,3)<SALES_PAST_REACH_RATE_OLD_PROD_BEV1SN THEN 'A'
                      WHEN SALES_AMT_PAST_MONTH_OLD_PROD<=0 THEN 'B' ELSE NULL END) AS SALES_PAST_REACH_RATE_OLD_PROD_F
         FROM APDC.DC0021_RPT0104_COM
