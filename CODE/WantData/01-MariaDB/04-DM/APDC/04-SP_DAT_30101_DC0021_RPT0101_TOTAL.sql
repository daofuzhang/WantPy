DROP PROCEDURE IF EXISTS APDC.SP_DAT_30101_DC0021_RPT0101_TOTAL;

CREATE PROCEDURE APDC.SP_DAT_30101_DC0021_RPT0101_TOTAL (
...
BEGIN
    ...
    INSERT INTO APDC.DC0021_RPT0101_TOTAL
    SELECT VAR_DATA_DATE AS DATA_DATE
         , VAR_DATA_DATE AS RPT_YMD
         , 0 AS WORK_DAY
         , 0 AS WORK_TOTAL_DAY
         , 0 AS WORK_RATIO
         , (CASE WHEN RPT_YMD=VAR_DATA_DATE THEN SUM(SALES_AMT_UNPOST) ELSE 0 END) AS SALES_AMT_UNPOST
         , (CASE WHEN RPT_YMD=VAR_DATA_DATE THEN ROUND(SUM(SALES_AMT_UNPOST)/1000,0) ELSE 0 END) AS SALES_AMT_UNPOST_V
         , 0 AS BILLING_D3
         , 0 AS BILLING_D3_V
    ...
    --UPDATE2
    --WORK_RATIO 標準進度
    UPDATE APDC.DC0021_RPT0101_TOTAL A
    ...
    --UPDATE3
    --DC0021_SALES_DIST_PROD_DATE-日業績金額總計
    UPDATE APDC.DC0021_RPT0101_TOTAL A
    ...
    UPDATE APDC.DC0021_RPT0101_TOTAL A
    JOIN(SELECT ROUND(M.BILLING/M.SALES_AMT_PAST_MONTH,3) AS PAST_PROG_REACH_RATE_BILLING
              , M.PAST_PROG_REACH_RATE_BILLING_F AS PAST_PROG_REACH_RATE_BILLING_F
              , ROUND(M.SALES_AMT/M.SALES_AMT_PAST_MONTH,3) AS PAST_PROG_REACH_RATE_POST
              , M.PAST_PROG_REACH_RATE_POST_F AS PAST_PROG_REACH_RATE_POST_F
              , ROUND((M.BILLING/M.SALES_AMT_PAST_MONTH_PROG)-1,3) AS PAST_PROG_GROWTH_RATE_BILLING
              , M.PAST_PROG_GROWTH_RATE_BILLING_F AS PAST_PROG_GROWTH_RATE_BILLING_F
              , ROUND((M.BILLING/M.SALES_AMT_PAST_MONTH_PROG)-1,3) AS PAST_PROG_GROWTH_RATE_POST
              , M.PAST_PROG_GROWTH_RATE_POST_F AS PAST_PROG_GROWTH_RATE_POST_F
              ...
              , M.SALES_AMT_PAST_PROG_DIFF_BILLING_F AS SALES_AMT_PAST_PROG_DIFF_BILLING_F
              ...
              , M.SALES_AMT_PAST_PROG_DIFF_POST_F AS SALES_AMT_PAST_PROG_DIFF_POST_F
         FROM(
             SELECT RPT_YMD
                  ...
                  , (CASE WHEN RPT_YMD=@RPT_YMD_END THEN 'Z' ELSE NULL END) AS PAST_PROG_REACH_RATE_BILLING_F
                  , (CASE WHEN RPT_YMD<>@RPT_YMD_END THEN 'Z' ELSE NULL END) AS PAST_PROG_REACH_RATE_POST_F
                  , (CASE WHEN RPT_YMD=@RPT_YMD_END THEN 'Z' ELSE NULL END) AS PAST_PROG_GROWTH_RATE_BILLING_F
                  , (CASE WHEN RPT_YMD<>@RPT_YMD_END THEN 'Z' ELSE NULL END) AS PAST_PROG_GROWTH_RATE_POST_F
                  , (CASE WHEN RPT_YMD=@RPT_YMD_END THEN 'Z' ELSE NULL END) AS SALES_AMT_PAST_PROG_DIFF_BILLING_F
                  , (CASE WHEN RPT_YMD<>@RPT_YMD_END THEN 'Z' ELSE NULL END) AS SALES_AMT_PAST_PROG_DIFF_POST_F
             FROM DMMDL.DC0021_SALES_DIST_PROD_DATE_CUM
             WHERE DATA_DATE=VAR_DATA_DATE
             )M) B
    ON A.DATA_DATE=B.DATA_DATE AND A.RPT_YMD=B.RPT_YMD
    ...
    UPDATE APDC.DC0021_RPT0101_TOTAL A
    JOIN(SELECT (M.INIT_BAL+M.PAY_AMT-M.BILLING) AS DIST_BAL_BILLING
              , (CASE WHEN ROUND((M.INIT_BAL+M.PAY_AMT-M.BILLING)/1000,0)<0 THEN 0 ELSE NULL END) AS DIST_BAL_BILLING_V
    ...
    UPDATE APDC.DC0021_RPT0101_TOTAL A
    JOIN(SELECT (CASE WHEN RPT_YMD=VAR_DATA_DATE THEN (CUM_BILLING_D1-FCST_AMT*WORK_RATIO) ELSE 0 END) AS FCST_AMT_PROG_DIFF_BILLING
              ...
              , (CASE WHEN RPT_YMD=@RPT_YMD_END THEN 'Z' ELSE NULL END) AS FCST_AMT_PROG_DIFF_BILLING_F
              ...
              , (CASE WHEN RPT_YMD<>@RPT_YMD_END THEN 'Z' ELSE NULL END) AS FCST_AMT_PROG_DIFF_POST_F
         ...
         FROM APDC.DC0021_RPT0101_TOTAL
         WHERE DATA_DATE=VAR_DATA_DATE) B
    ON A.DATA_DATE=B.DATA_DATE AND A.RPT_YMD=B.RPT_YMD
    SET A.FCST_AMT_PROG_DIFF_BILLING=B.FCST_AMT_PROG_DIFF_BILLING
