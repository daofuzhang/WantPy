DROP PROCEDURE IF EXISTS APDC.SP_DAT_30106_DC0021_RPT0101_DIVISIOND;

CREATE PROCEDURE APDC.SP_DAT_30106_DC0021_RPT0101_DIVISIOND (
...
BEGIN
    ...
    INSERT INTO APDC.DC0021_RPT0101_DIVISIOND
    ...
    --UPDATE2
    --從直式取MAX
    UPDATE APDC.DC0021_RPT0101_DIVISIOND A 
    ...
    JOIN(SELECT DIVISIONC_ID
         ...
         FROM APDC.DC0021_RPT0101_DIVISIOND
         WHERE DATA_DATE=VAR_DATA_DATE
         GROUP BY DIVISIONC_ID
                , DIVISION_ID
                , DIVISIOND_ID) B
    ON A.DATA_DATE=B.DATA_DATE AND A.RPT_YMD=B.RPT_YMD AND A.DIVISIONC_ID=B.DIVISIONC_ID AND A.DIVISION_ID=B.DIVISION_ID AND A.DIVISIOND_ID=B.DIVISIOND_ID
