DROP PROCEDURE IF EXISTS APDC.SP_DAT_30117_DC0021_RPT0104_DISTRICT8;

CREATE PROCEDURE APDC.SP_DAT_30117_DC0021_RPT0104_DISTRICT8 (
...
BEGIN
    ...
    --INSERT1
    INSERT INTO APDC.DC0021_RPT0104_DISTRICT8
    ...
    --UPDATE2
    --新品帳餘
    UPDATE APDC.DC0021_RPT0104_DISTRICT8 A
    ...
    ON A.DATA_DATE=B.DATA_DATE AND A.RPT_YMD=B.RPT_YMD AND A.DIVISION_ID=B.DIVISION_ID AND A.DISTRICT8_ID=B.DISTRICT8_ID
    ...
    JOIN(SELECT DIVISION_ID
         ...
         FROM APDC.DC0021_RPT0104_DISTRICT8
         WHERE DATA_DATE=VAR_DATA_DATE AND RPT_YMD=VAR_DATA_DATE
         GROUP BY DIVISION_ID
                , DISTRICT8_ID) B
    ON A.DATA_DATE=B.DATA_DATE AND A.RPT_YMD=B.RPT_YMD AND A.DIVISION_ID=B.DIVISION_ID AND A.DISTRICT8_ID=B.DISTRICT8_ID AND A.DIST8_SUPV_ID=B.DIST8_SUPV_ID
