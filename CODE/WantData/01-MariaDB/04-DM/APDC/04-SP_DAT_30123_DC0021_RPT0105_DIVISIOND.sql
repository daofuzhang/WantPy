DROP PROCEDURE IF EXISTS APDC.SP_DAT_30123_DC0021_RPT0105_DIVISIOND;

CREATE PROCEDURE APDC.SP_DAT_30123_DC0021_RPT0105_DIVISIOND (
...
BEGIN
    ...
    INSERT INTO APDC.DC0021_RPT0105_DIVISIOND
    ...
    --UPDATE2
    --WORK_RATIO 標準進度
    UPDATE APDC.DC0021_RPT0105_DIVISIOND A
    ...
    JOIN(SELECT DIVISIONC_ID
              ...
              , (CASE WHEN ROUND(FY1_SALES_AMT/FY1_SALES_AMT_PAST_MONTH,3)<0 THEN 'A'
         ...
         FROM APDC.DC0021_RPT0105_DIVISIOND
         WHERE DATA_DATE=VAR_DATA_DATE
