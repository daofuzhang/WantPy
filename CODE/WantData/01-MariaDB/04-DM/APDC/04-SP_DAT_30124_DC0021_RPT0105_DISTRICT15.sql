DROP PROCEDURE IF EXISTS APDC.SP_DAT_30124_DC0021_RPT0105_DISTRICT15;

CREATE PROCEDURE APDC.SP_DAT_30124_DC0021_RPT0105_DISTRICT15 (
...
BEGIN
    ...
    INSERT INTO APDC.DC0021_RPT0105_DISTRICT15
    ...
    --UPDATE2
    --WORK_RATIO 標準進度
    UPDATE APDC.DC0021_RPT0105_DISTRICT15 A
    ...
    JOIN(SELECT DIVISION_ID
         ...
         GROUP BY DIVISION_ID
                , DIVISIOND_ID
                , DISTRICT15_ID) B
    ON A.DATA_DATE=B.DATA_DATE AND A.DIVISION_ID=B.DIVISION_ID AND A.DIVISIOND_ID=B.DIVISIOND_ID AND A.DISTRICT15_ID=B.DISTRICT15_ID
    ...
    JOIN(SELECT DIVISIONC_ID
              ...
              , (CASE WHEN RPT_YMD=VAR_DATA_DATE THEN ROUND((SALES_AMT_REACH_MONTH/SALES_AMT_PAST_MONTH)-1,3) AS PAST_MONTH_GROWTH_RATE
              , (CASE WHEN RPT_YMD<>@RPT_YMD_END THEN 'Z'
