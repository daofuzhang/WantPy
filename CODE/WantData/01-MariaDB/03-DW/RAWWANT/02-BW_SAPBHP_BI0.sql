...
/*  Created On : 15-十一月-2018 上午 09:22:32 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
(
	...
	CONSTRAINT `PK_BW_SAPBHP_BI0_TSALESORG` PRIMARY KEY (`SALESORG`)
)
...
(
	...
	CONSTRAINT `PK_BW_SAPBHP_BI0_TSALES_OFF` PRIMARY KEY (`SALES_OFF`)
)
...
(
	...
	`LANGU` VARCHAR(1) NOT NULL,
	`TXTLG` VARCHAR(60) NOT NULL,
	CONSTRAINT `PK_BW_SAPBHP_BI0_TPROD_HIER` PRIMARY KEY (`PROD_HIER`)
)
...
(
	...
	CONSTRAINT `PK_BW_SAPBHP_BI0_TMATERIAL` PRIMARY KEY (`MATERIAL`)
)
...
(
	...
	`LANGU` VARCHAR(1) NOT NULL,
	`TXTSH` VARCHAR(20) NOT NULL,
	CONSTRAINT `PK_BW_SAPBHP_BI0_TDIVISION` PRIMARY KEY (`DIVISION`)
)
...
(
	...
	`LANGU` VARCHAR(1) NOT NULL,
	`TXTSH` VARCHAR(20) NOT NULL,
	CONSTRAINT `PK_BW_SAPBHP_BI0_TDISTR_CHAN` PRIMARY KEY (`DISTR_CHAN`)
)
...
(
	...
	`TXTMD` VARCHAR(40) NOT NULL,
	CONSTRAINT `PK_BW_SAPBHP_BI0_TCUSTOMER` PRIMARY KEY (`CUSTOMER`)
)
...
(
	...
	`TXTMD` VARCHAR(40) NOT NULL,
	`TXTLG` VARCHAR(60) NOT NULL,
	CONSTRAINT `PK_BW_SAPBHP_BI0_TC_CTR_AREA` PRIMARY KEY (`C_CTR_AREA`)
)
...
(
	...
	CONSTRAINT `PK_BW_SAPBHP_BI0_PMATERIAL` PRIMARY KEY (`MATERIAL`)
)
...
(
	...
	CONSTRAINT `PK_BW_SAPBHP_BI0_PCUSTOMER` PRIMARY KEY (`CUSTOMER`)
)
...
(
	...
	`SALES_OFF` VARCHAR(4) NOT NULL,
	`BIC_ZWW_COMPY` VARCHAR(4) NOT NULL,
	CONSTRAINT `PK_BW_SAPBHP_BI0_PCUST_SALES` PRIMARY KEY (`DIVISION`,`DISTR_CHAN`,`SALESORG`,`CUST_SALES`)
)
...
(
	...
	CONSTRAINT `PK_BW_SAPBHP_BI0_AFIAR_O0300` PRIMARY KEY (`COMP_CODE`,`DEBITOR`,`FISCPER`,`FISCVARNT`,`AC_DOC_NO`,`ITEM_NUM`,`FI_DSBITEM`)
)
