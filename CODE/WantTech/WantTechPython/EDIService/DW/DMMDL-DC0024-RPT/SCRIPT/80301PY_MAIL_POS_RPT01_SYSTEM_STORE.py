...
def getPOSRPT01StorePCSList(strEDIConnection, strEDIDB, strDataDate):
    strSQL = "SELECT KA_SYSTEM_CODE, KA_SYSTEM_NM, KA_SYSTEM_ACT_NM " + \
             "     , SALES_COM_ID_SA, SALES_COM_ABR_SA, SALES_COM_ID_WH, SALES_COM_ABR_WH " + \
             "     , CONCAT(KA_SYSTEM_CODE, '-', KA_STORE_CODE) AS KA_STORE_CODE, KA_STORE_NM, POS_WEEK_NUM " + \
             "     , ROUND(POS_QTY_PCS, 0) AS POS_QTY_PCS " + \
             "FROM DMMDL.DC0024_POS_RPT01_STORE " + \
             "WHERE CONVERT(POS_WEEK_NUM, INT)>=(CONVERT(LEFT({DATA_DATE}, 4), INT) - 1)*100+49 " + \
             "ORDER BY KA_SYSTEM_CODE, SALES_COM_ID_SA, SALES_COM_ID_WH, KA_STORE_CODE, POS_WEEK_NUM DESC; "
    ...
    listPOSRPT01StorePCS = DBEntity.getMariaDataList(strEDIConnection, strEDIDB, strSQL)
    return listPOSRPT01StorePCS

def getPOSRPT01StoreSKUList(strEDIConnection, strEDIDB, strDataDate):
    strSQL = "SELECT KA_SYSTEM_CODE, KA_SYSTEM_NM, KA_SYSTEM_ACT_NM " + \
             "     , SALES_COM_ID_SA, SALES_COM_ABR_SA, SALES_COM_ID_WH, SALES_COM_ABR_WH " + \
             "     , CONCAT(KA_SYSTEM_CODE, '-', KA_STORE_CODE) AS KA_STORE_CODE, KA_STORE_NM, POS_WEEK_NUM " + \
             "     , POS_SKU " + \
    ...
    listPOSRPT01StoreSKU = DBEntity.getMariaDataList(strEDIConnection, strEDIDB, strSQL)
    return listPOSRPT01StoreSKU
...
def execWriteWorkbook(strJobPathRES, listWeekNum, listPOSRPT01, listPOSRPT01System, listPOSRPT01SystemPCS, listPOSRPT01SystemSKU, listPOSRPT01StorePCS, listPOSRPT01StoreSKU):
    if len(listWeekNum) == 0 or len(listPOSRPT01) == 0 or len(listPOSRPT01StorePCS) != len(listPOSRPT01StoreSKU) or len(listPOSRPT01SystemPCS) != len(listPOSRPT01SystemSKU):
        return False
    else:
        ...
        intPOSRPT01StoreIndex = 0

        intExcelRow = 0

        intNowDates = (Common.getDate(listPOSRPT01[0]["POS_DATE"]) - Common.getDate(listWeekNum[0]["WEEK_FIRST_DATE"])).days + 1

        while intPOSRPT01StoreIndex < len(listPOSRPT01StorePCS):
            if strKA_SYSTEM_CODE != listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["KA_SYSTEM_CODE"]:
                strKA_SYSTEM_ACT_NM = listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["KA_SYSTEM_ACT_NM"]
                strKA_SYSTEM_CODE = listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["KA_SYSTEM_CODE"]
                strKA_SYSTEM_NM = listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["KA_SYSTEM_NM"]
                ...
                objExcelWorksheet.merge_range("A1:I1", "现代渠道发展营业部业绩－通路系统门店周别POS推移", objExcelTitleFormat)
                ...
                objExcelWorksheet.merge_range("H3:H4", "门店编码", objExcelColumnFormat)
                objExcelWorksheet.merge_range("I3:I4", "门店名称", objExcelColumnFormat)
            ...
            objExcelWorksheet.write(intExcelRow, 0, listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["KA_SYSTEM_ACT_NM"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 1, listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["KA_SYSTEM_CODE"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 2, listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["KA_SYSTEM_NM"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 3, listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["SALES_COM_ID_SA"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 4, listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["SALES_COM_ABR_SA"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 5, listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["SALES_COM_ID_WH"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 6, listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["SALES_COM_ABR_WH"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 7, listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["KA_STORE_CODE"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 8, listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["KA_STORE_NM"], objExcelRowLeftFormat)
            objExcelWorksheet.write(intExcelRow, 9, "销售数量", objExcelRowCenterFormat)
            ...
            intTemp = 0
            for dictWeekNum in listWeekNum:
                intIndexTemp = intPOSRPT01StoreIndex + intIndexCount
                if intIndexTemp < len(listPOSRPT01StorePCS) and \
                   listPOSRPT01StorePCS[intIndexTemp]["KA_SYSTEM_CODE"] == strKA_SYSTEM_CODE and \
                   listPOSRPT01StorePCS[intIndexTemp]["KA_STORE_CODE"] == listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["KA_STORE_CODE"] and \
                   listPOSRPT01StorePCS[intIndexTemp]["POS_WEEK_NUM"] == listWeekNum[intTemp]["WEEK_NUM"]:

                    strDirection = ""
                    decTarget = 0
                    objExcelRowIconDirFormat = objExcelRowIconFormat
                    if (intIndexTemp + 1) < len(listPOSRPT01StorePCS) and (intTemp + 1) < len(listWeekNum) and \
                       listPOSRPT01StorePCS[intIndexTemp + 1]["KA_SYSTEM_CODE"] == strKA_SYSTEM_CODE and \
                       listPOSRPT01StorePCS[intIndexTemp + 1]["KA_STORE_CODE"] == listPOSRPT01StorePCS[intPOSRPT01StoreIndex]["KA_STORE_CODE"] and \
                       listPOSRPT01StorePCS[intIndexTemp + 1]["POS_WEEK_NUM"] == listWeekNum[intTemp + 1]["WEEK_NUM"]:

                        if intTemp == 0:
                            decTarget = round(listPOSRPT01StorePCS[intIndexTemp + 1]["POS_QTY_PCS"] / 7 * intNowDates, 0)
                        else:
                            decTarget = listPOSRPT01StorePCS[intIndexTemp + 1]["POS_QTY_PCS"]

                        if listPOSRPT01StorePCS[intIndexTemp]["POS_QTY_PCS"] > decTarget:
                            strDirection = "▲"
                            if objExcelRowIconFormat == objExcelRowIcon1Format:
                                objExcelRowIconDirFormat = objExcelRowIcon1UpFormat
                            else:
                        ...
                        elif listPOSRPT01StorePCS[intIndexTemp]["POS_QTY_PCS"] < decTarget:
                            strDirection = "▼"
                            if objExcelRowIconFormat == objExcelRowIcon1Format:
                                objExcelRowIconDirFormat = objExcelRowIcon1DownFormat
                            else:
                    ...
                    objExcelWorksheet.write(intExcelRow, 10 + intTemp * 2, listPOSRPT01StorePCS[intIndexTemp]["POS_QTY_PCS"], objExcelRowRightFormat)
                    objExcelWorksheet.write(intExcelRow, 10 + intTemp * 2 + 1, strDirection, objExcelRowIconDirFormat)
                    intIndexCount += 1
                    intTemp += 1
                else:
            ...
            objExcelWorksheet.write(intExcelRow, 0, listPOSRPT01StoreSKU[intPOSRPT01StoreIndex]["KA_SYSTEM_ACT_NM"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 1, listPOSRPT01StoreSKU[intPOSRPT01StoreIndex]["KA_SYSTEM_CODE"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 2, listPOSRPT01StoreSKU[intPOSRPT01StoreIndex]["KA_SYSTEM_NM"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 3, listPOSRPT01StoreSKU[intPOSRPT01StoreIndex]["SALES_COM_ID_SA"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 4, listPOSRPT01StoreSKU[intPOSRPT01StoreIndex]["SALES_COM_ABR_SA"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 5, listPOSRPT01StoreSKU[intPOSRPT01StoreIndex]["SALES_COM_ID_WH"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 6, listPOSRPT01StoreSKU[intPOSRPT01StoreIndex]["SALES_COM_ABR_WH"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 7, listPOSRPT01StoreSKU[intPOSRPT01StoreIndex]["KA_STORE_CODE"], objExcelRowCenterFormat)
            objExcelWorksheet.write(intExcelRow, 8, listPOSRPT01StoreSKU[intPOSRPT01StoreIndex]["KA_STORE_NM"], objExcelRowLeftFormat)
            objExcelWorksheet.write(intExcelRow, 9, "品项数", objExcelRowCenterFormat)
            ...
            for dictWeekNum in listWeekNum:
                intIndexTemp = intPOSRPT01StoreIndex + intIndexCount
                if intIndexTemp < len(listPOSRPT01StoreSKU) and \
                   listPOSRPT01StoreSKU[intIndexTemp]["KA_SYSTEM_CODE"] == strKA_SYSTEM_CODE and \
                   listPOSRPT01StoreSKU[intIndexTemp]["KA_STORE_CODE"] == listPOSRPT01StoreSKU[intPOSRPT01StoreIndex]["KA_STORE_CODE"] and \
                   listPOSRPT01StoreSKU[intIndexTemp]["POS_WEEK_NUM"] == listWeekNum[intTemp]["WEEK_NUM"]:

                    strDirection = ""
                    decTarget = 0
                    objExcelRowIconDirFormat = objExcelRowIconFormat
                    if (intIndexTemp + 1) < len(listPOSRPT01StoreSKU) and (intTemp + 1) < len(listWeekNum) and \
                       listPOSRPT01StoreSKU[intIndexTemp + 1]["KA_SYSTEM_CODE"] == strKA_SYSTEM_CODE and \
                       listPOSRPT01StoreSKU[intIndexTemp + 1]["KA_STORE_CODE"] == listPOSRPT01StoreSKU[intPOSRPT01StoreIndex]["KA_STORE_CODE"] and \
                       listPOSRPT01StoreSKU[intIndexTemp + 1]["POS_WEEK_NUM"] == listWeekNum[intTemp + 1]["WEEK_NUM"]:

                        decTarget = listPOSRPT01StoreSKU[intIndexTemp + 1]["POS_SKU"]

                        if listPOSRPT01StoreSKU[intIndexTemp]["POS_SKU"] > decTarget:
                            strDirection = "▲"
                            if objExcelRowIconFormat == objExcelRowIcon1Format:
                                objExcelRowIconDirFormat = objExcelRowIcon1UpFormat
                            else:
                        ...
                        elif listPOSRPT01StoreSKU[intIndexTemp]["POS_SKU"] < decTarget:
                            strDirection = "▼"
                            if objExcelRowIconFormat == objExcelRowIcon1Format:
                                objExcelRowIconDirFormat = objExcelRowIcon1DownFormat
                            else:
                    ...
                    objExcelWorksheet.write(intExcelRow, 10 + intTemp * 2, listPOSRPT01StoreSKU[intIndexTemp]["POS_SKU"], objExcelRowRightFormat)
                    objExcelWorksheet.write(intExcelRow, 10 + intTemp * 2 + 1, strDirection, objExcelRowIconDirFormat)
                    intIndexCount += 1
                    intTemp += 1
                else:
            ...
            intPOSRPT01StoreIndex += intIndexCount
...
def execMailPOSRPT01(strJobPathRES, strDataDate):
    ...
    if listPOSRPT01[0]["POS_DATE"] == listPOSRPT01[0]["WEEK_LAST_DATE"]:
        ...
        listPOSRPT01StorePCS = getPOSRPT01StorePCSList(strEDIConnection, strEDIDB, strDataDate)
        listPOSRPT01StoreSKU = getPOSRPT01StoreSKUList(strEDIConnection, strEDIDB, strDataDate)
        
        if execWriteWorkbook(strJobPathRES, listWeekNum, listPOSRPT01, listPOSRPT01System, listPOSRPT01SystemPCS, listPOSRPT01SystemSKU, listPOSRPT01StorePCS, listPOSRPT01StoreSKU) == True:
            ...
            for dictPOSRPT01System in listPOSRPT01System:
                strMessageSubject = dictPOSRPT01System["KA_SYSTEM_NM"] + "-现代渠道发展营业部业绩-通路系统门店周别POS推移-" + listPOSRPT01[0]["POS_DATE"]
                strContent = "尊敬的长官：早上好！\n敬请查阅：截止" + listPOSRPT01[0]["POS_DATE"][4:6] + "月" + listPOSRPT01[0]["POS_DATE"][-2:] + "日【" + dictPOSRPT01System["KA_SYSTEM_NM"] + "-现代渠道发展营业部业绩-通路系统门店周别POS推移报表】\n\n"
                strAttachFilePath = strJobPathRES.replace(".dat", "-" + dictPOSRPT01System["KA_SYSTEM_CODE"] + ".dat")
                strAttachFileName = dictPOSRPT01System["KA_SYSTEM_NM"] + "-现代渠道发展营业部业绩-通路系统门店周别POS推移-" + listPOSRPT01[0]["POS_DATE"] + ".xlsx"

                if dictPOSRPT01System["KA_SYSTEM_CODE"] == "H002":
                    #  H002 大润发 : 胡朝杰 / 成骏 / 郭丹丹
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Cheng_Jun2@want-want.com", "Guo_DanDan@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "H005":
                    #  H005 麦德龙 : 胡朝杰 / 左晓云 / 成骏 / 崔建辉
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Zuo_XiaoYun2@want-want.com", "Cheng_Jun2@want-want.com", "Cui_JianHui@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "H007":
                    #  H007 人人乐 : 胡朝杰 / 郭鹏 / 宋涛
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Guo_Peng@want-want.com", "Song_Tao2@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "H009":
                    #  H009 世纪联华 : 胡朝杰 / 郭鹏 / 成骏 / 宋涛
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Guo_Peng@want-want.com", "Cheng_Jun2@want-want.com", "Song_Tao2@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "H010":
                    #  H010 沃尔玛 : 胡朝杰 / 郭鹏 / 王勇 / 成骏
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Guo_Peng@want-want.com", "Wang_Yong@want-want.com", "Cheng_Jun2@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "H011":
                    #  H011 物美 : 胡朝杰 / 陈寿明 / 胡雪斌 / 黄华 / 王珑 / 鲍冠杰
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "chen_shouming@want-want.com", "hu_xuebin@want-want.com", "Huang_Hua@want-want.com", "Wang_Long2@want-want.com", "Bao_GuanJie@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "H013":
                    #  H013 易初莲花 : 胡朝杰 / 左晓云 / 成骏 / 崔建辉
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Zuo_XiaoYun2@want-want.com", "Cheng_Jun2@want-want.com", "Cui_JianHui@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "H016":
                    #  H016 丹尼斯 : 胡朝杰 / 黄艳丽 
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "huang_yanli2@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "H017":
                    #  H017 天虹 : 胡朝杰 / 章丽萍 / 张健 / 何丽琴
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Zhang_LiPing2@want-want.com", "Zhang_Jian7@want-want.com", "he_liqin@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "H018":
                    #  H018 华润万家 : 胡朝杰 / 郭鹏 / 高贺 / 成骏
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Guo_Peng@want-want.com", "Gao_He@want-want.com", "Cheng_Jun2@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "H021":
                    #  H021 美特好 : 胡朝杰 / 杨文卿 
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "yang_wenqing@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "H042":
                    #  H042 百佳华 : 胡朝杰 / 王从阳 / 雷艳红 / 何丽琴
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "wang_chongyang@want-want.com", "lei_yanhong@want-want.com", "he_liqin@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "H060":
                    #  H060 北国系统 : 胡朝杰 / 艾贵银 
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "ai_guiyin@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S001":
                    #  S001 农工商 : 胡朝杰 / 郭鹏 / 成骏
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Guo_Peng@want-want.com", "Cheng_Jun2@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S004":
                    #  S004 上海联华 : 胡朝杰 / 郭鹏 / 成骏 / 宋涛
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Guo_Peng@want-want.com", "Cheng_Jun2@want-want.com", "Song_Tao2@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S006":
                    #  S006 苏果 : 胡朝杰 / 杨斯竣 / 成骏
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Yang_SiJun@want-want.com", "Cheng_Jun2@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S009":
                    #  S009 中百便民 : 胡朝杰 / 王宁 
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "wang_ning2@want-want.com", "Zoe.Hsu@want-want.com" ]
                    ...
                    #  S014 永辉 : 胡朝杰 / 徐俊 / 张利霞 / 成骏
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Xu_Jun6@want-want.com", "Zhang_LiXia@want-want.com", "Cheng_Jun2@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S018":
                    #  S018 武商 : 胡朝杰 / 王宁 
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "wang_ning2@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S020":
                    #  S020 威海糖酒 : 胡朝杰 / 陈寿明 / 徐瑞虎
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "chen_shouming@want-want.com", "Xu_Ruihu@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S026":
                    #  S026 新世纪 : 胡朝杰 / 刘爱民 
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Liu_AiMin@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S030":
                    #  S030 红旗连锁 : 胡朝杰 / 向君 
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "xiang_jun@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S031":
                    #  S031 银座 : 胡朝杰 / 陈寿明 / 黄艳丽 / 徐瑞虎 / 王冰冰
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "chen_shouming@want-want.com", "huang_yanli2@want-want.com", "Xu_Ruihu@want-want.com", "wang_bingbing@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S044":
                    #  S044 北京华冠 : 胡朝杰 / 陈寿明 
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "chen_shouming@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S052":
                    #  S052 步步高 : 胡朝杰 / 张健 
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "Zhang_Jian7@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S063":
                    #  S063 新华都 : 胡朝杰 / 朱巧燕 
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "zhu_qiaoyan@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S110":
                    #  S110 联华华商 : 胡朝杰 / 胡雪斌 / 鲍冠杰
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "hu_xuebin@want-want.com", "Bao_GuanJie@want-want.com", "Zoe.Hsu@want-want.com" ]
                elif dictPOSRPT01System["KA_SYSTEM_CODE"] == "S151":
                    #  S151 华联系统 : 胡朝杰 / 王冰冰
                    arrayMessageSMTPTo = [ "Allen.Hu@want-want.com", "wang_bingbing@want-want.com", "Zoe.Hsu@want-want.com" ]
